...
calls = client.get_calls(
    filter={"op_names": ["weave:///grpo-cuda/dataset-rollout/op/Evaluation.predict_and_score:nLHkt0g39v37SSRn7yuZglKjboXicyHRcwrGBixaQio"],"parent_ids": ["0197a630-ff20-7ca1-a99d-e39346178255"]},
    query={"$expr":{"$gt":[{"$getField":"started_at"},{"$literal":1750246783.404}]}},
