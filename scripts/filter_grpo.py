...
calls = client.get_calls(
    filter={"op_names": ["weave:///grpo-cuda/dataset-rollout/op/Evaluation.predict_and_score:nLHkt0g39v37SSRn7yuZglKjboXicyHRcwrGBixaQio"],"parent_ids": ["0197ab22-a98a-7810-b38f-cc1f5aea05f1"]},
    query={"$expr":{"$gt":[{"$getField":"started_at"},{"$literal":1750338087.106}]}},
...
# ds.save_to_disk("calls_with_is_correct2.json")
# ds.push_to_hub("tcapelle/boostrap_oai_pt_think_ep2")