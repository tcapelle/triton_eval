...
def test_bitwise_and():
    ...
    input1 = torch.tensor([1, 2, 3], dtype=torch.int32, device='cpu')
    other1 = torch.tensor([3, 2, 1], dtype=torch.int32, device='cpu')
    results["test_case_1"] = bitwise_and(input1, other1)

    # Test case 2: Bitwise AND with boolean tensors
    input2 = torch.tensor([True, False, True], dtype=torch.bool, device='cpu')
    other2 = torch.tensor([False, False, True], dtype=torch.bool, device='cpu')
    results["test_case_2"] = bitwise_and(input2, other2)

    # Test case 3: Bitwise AND with different shapes (broadcasting)
    input3 = torch.tensor([[1, 2], [3, 4]], dtype=torch.int32, device='cpu')
    other3 = torch.tensor([1, 0], dtype=torch.int32, device='cpu')
    results["test_case_3"] = bitwise_and(input3, other3)

    # Test case 4: Bitwise AND with scalar tensor
    input4 = torch.tensor([1, 2, 3], dtype=torch.int32, device='cpu')
    other4 = torch.tensor(2, dtype=torch.int32, device='cpu')
